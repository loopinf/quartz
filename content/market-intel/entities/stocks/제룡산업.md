...
- 설명: 금속관련주, 시총2100억대, 전기기자재사업, 전력기기 업체들의 북미 데이터센터 관련된 수주가 1분기 큰 폭 성장(NH투자증권 리포트 발행)으로 전력기기 섹터에 대한 모멘텀 생성
- 리스크 플래그: 없음
...
<div class="mi-related-inline-list"><div class="mi-related-inline-item"><a class="mi-related-inline-name" href="/market-intel/entities/stocks/%EC%84%B8%EB%AA%85%EC%A0%84%EA%B8%B0">세명전기</a><div class="mi-related-inline-spark-wrap"><img class="mi-related-inline-sparkline" src="/market-intel/assets/stock-related-sparklines/%EC%A0%9C%EB%A3%A1%EC%82%B0%EC%97%85/%EC%84%B8%EB%AA%85%EC%A0%84%EA%B8%B0.svg" alt="세명전기 최근 20거래일 흐름" loading="lazy" /><span class="mi-related-inline-delta">+36.2%</span></div></div></div>

- [[market-intel/entities/stocks/세명전기|세명전기]]
